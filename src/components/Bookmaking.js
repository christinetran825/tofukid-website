  ...
  render(){
    return (
      <section idbook="books">
        ...
        <div className="book">
          <div className="blurb">
            <h3 className="proj-name">A Seahorse's Journey</h3>
            <h5 className="proj-tools">Type: Accordion | Tools: Mix Paper</h5>
            <p className="proj-description">Hand-cut scraps of specialty paper were used for texture, patterns, and color. A sprinkle of illustrations capture an underwater world through a seahorse's point of view as it searches for friendship.</p>
          </div>
          <div className="proj-img">
        ...
        <div className="book">
          <div className="blurb">
            <h3 className="proj-name">A Very Hungry Snake</h3>
            <h5 className="proj-tools">Type: Accordion with Prochoir Method | Tools: Mix Paper, Ink, Stamps</h5>
            <p className="proj-description">I found some great textured paper that look like a snake's scales. I thought a snake's length would be a great way to express the accordion structure and the story's content. The illustration was made to show the inside of a snake to see what it ate throughout a period of time. Using the Prochoir method, I transfered printed clip arts and text. In the future, I'll recreate this story and technique to create exaggerations for a more humorous story.</p>
          </div>
          <div className="proj-img">
        ...
        <div className="book">
          <div className="blurb">
            <h3 className="proj-name">Auspicious Hopes</h3>
            <h5 className="proj-tools">Type: Custom | Tools: Mix Paper, Print Text, Book Cloth, Personal Trinkets</h5>
            <p className="proj-description">I've collected many red envelopes given to me during Chinese New Years and my birthday. Most cherished are the ones with my Chinese name written by my grandpa. I've also collected some fortune cookie slips during 2011-2012 when I had a year long fortune cookie craving. Many of the slips are poetic while others are humorous. Filled with hope, excitement, and love, I decided to create a book using the fortune slips to create my own poem that reflected my life at the time. I filled each envelope with old trinkets like dried flowers symbolizing each labeled fortune.</p>
            <p className="proj-notes">Note - A slight design error: The title of my Chinese name should have been printed in red and gold, not white and black. White and black symbolizes the opposite of auspiciousness.</p>
          </div>
          <div className="proj-img">
