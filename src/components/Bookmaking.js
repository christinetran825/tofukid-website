...
class Bookmaking extends Component {
  render(){
    return (
      <section className="bookarts">
        <h1>Book Arts</h1>
        <div className="book">
          <h4>Sending Hugs</h4>
          <span>1st place MFA: Book Arts - AAU Spring Show 2013</span>
        ...
        <div className="book">
          ...
          <p>* Note: A slight design error: The title of my Chinese name should have been printed in red and gold, not white and black. White and black symbolizes the opposite of auspiciousness.</p>
          <p>Pictures Here</p>
        </div>
      </section>
    )
